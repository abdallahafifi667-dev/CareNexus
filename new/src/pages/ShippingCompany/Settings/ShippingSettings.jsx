...
import { changeDoctorPassword } from "../../Doctor/stores/doctorService";
...
const ShippingSettings = () => {
  ...
  const { loading, error } = useSelector((state) => state.shipping);
  ...
  useEffect(() => {
    dispatch(setCurrentTitle(t("nav.settings", { defaultValue: "Account Settings" })));
  }, [dispatch, t]);
  ...
  return (
    <motion.div
      className="shipping-settings-container"
      ...
      <div className="settings-section">
        ...
        <div className="settings-card">
          ...
          <SettingToggle
            ...
            description="Get notified when a client chats with you."
