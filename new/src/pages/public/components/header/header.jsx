...
const Header = () => {
  ...
  return (
    <header
      className={`header ${isSticky ? "sticky" : "initial"} ${isHome ? "home-header" : "sub-header"} ${scrolled ? "scrolled" : ""} ${isMobileMenuOpen ? "mobile-menu-active" : ""}`}
    >
      <div className="container nav-container">
        ...
        <nav className={`nav-links ${isMobileMenuOpen ? "open" : ""}`}>
          ...
          <Link to="/medical-ai" className="nav-link ai-link">
            {t("nav.medical_ai")}
          </Link>
          <Link to="/knowledge-ai" className="nav-link">
            {t("nav.knowledge_ai")}
          </Link>
