      ...
      <section className="services-hero">
        ...
        <div className="container">
          <span className="hero-badge">
            {t("services.badge", "Platform Services")}
          </span>
          <h1>
            {t(
              "services.hero.title",
              "Everything Your Healthcare Journey Needs",
            )}
          </h1>
          <p>
            {t(
              "services.hero.subtitle",
              "CareNexus is a full-stack medical platform that connects patients, doctors, nurses, pharmacists and shipping companies — powered by AI, real-time infrastructure, and bank-grade security.",
            )}
          </p>
              ...
              >
                ...
                <ul className="feature-list">
                  {svc.features.map((f, i) => (
                    <li key={i}>
                      <span className="feat-icon" style={{ color: svc.color }}>
                        {f.icon}
                      </span>
                      {t(f.text, f.text)}
                    </li>
      ...
      <section className="how-it-works">
        <div className="container">
          ...
          <p className="section-sub">
            {t(
              "services.how.sub",
              "A seamless flow from patient request to service completion",
            )}
          </p>
            ...
            {[
              {
                num: "01",
                icon: <Lock size={24} />,
                titleKey: "services.how.s1.title",
                descKey: "services.how.s1.desc",
              },
              {
                num: "02",
                icon: <MapPin size={24} />,
                titleKey: "services.how.s2.title",
                descKey: "services.how.s2.desc",
              },
              {
                num: "03",
                icon: <Zap size={24} />,
                titleKey: "services.how.s3.title",
                descKey: "services.how.s3.desc",
              },
              {
                num: "04",
                icon: <Star size={24} />,
                titleKey: "services.how.s4.title",
                descKey: "services.how.s4.desc",
              },
            ].map((step, i) => (
        ...
        <div className="container">
          <div className="security-inner">
            ...
            <div className="security-text">
              <h3>
                {t("services.security.title", "Enterprise-Grade Security")}
              </h3>
              <p>
                {t(
                  "services.security.desc",
                  "Every user is verified with AI-powered KYC — face detection, liveness checks, OCR document reading, and international ID format validation via AWS Rekognition and Google Vision API.",
                )}
              </p>
            </div>
