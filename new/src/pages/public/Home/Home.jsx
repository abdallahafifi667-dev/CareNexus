  ...
  const sliderSettings = React.useMemo(
    () => ({
      ...
      responsive: [
        {
          breakpoint: 1024,
          settings: { slidesToShow: 2, infinite: testimonials.length > 2 },
        },
        {
          breakpoint: 768,
          settings: { slidesToShow: 1, infinite: testimonials.length > 1 },
        },
      ],
    }),
      ...
      <section className="hero-section">
        <div className="hero-background">
          <img
            ...
            alt={t("home.hero_visual.nexus_alt")}
            className="nexus-bg"
            loading="lazy"
          />
            ...
            <div className="image-stack">
              <div className="stack-item main">
                <img
                  ...
                  alt={t("home.hero_visual.doctor_alt")}
                  loading="lazy"
                />
              </div>
              <div className="floating-stat">
                <span className="stat-num">
                  {t("home.hero_visual.accuracy_value")}
                </span>
                <span className="stat-label">
                  {t("home.hero_visual.accuracy_rate")}
                </span>
              </div>
            </div>
          </div>
            ...
            {[
              ...
              >
                ...
                <h3 className="card-title">
                  {t(`home.features.card${feature.id}_title`)}
                </h3>
                <p className="card-desc">
                  {t(`home.features.card${feature.id}_desc`)}
                </p>
                ...
                <div className="feature-highlights">
                  {[1, 2, 3].map((hIdx) => (
                    <div key={hIdx} className="highlight-item">
                      ...
                      <span>
                        {t(`home.features.card${feature.id}_h${hIdx}`)}
                      </span>
                    </div>
                  ))}
                </div>
          ...
          <div className="testimonials-slider-wrapper">
            {typeof Slider === "function" ? (
              <Slider ref={sliderRef} {...sliderSettings}>
                {(Array.isArray(testimonials) ? testimonials : []).map(
                  (test) => {
                    const name = t(`testimonials.${test.id}.name`, {
                      defaultValue: "",
                    });
                    const initials =
                      ...
                      <div key={test.id} className="testimonial-slide">
                        <div className="testimonial-card">
                          <div className="rating">
                            {[
                              ...Array(
                                Number.isFinite(test.rating) ? test.rating : 5,
                              ),
                            ].map((_, starI) => (
                              <Star
                                key={starI}
                          ...
                          <p className="content">
                            "{t(`testimonials.${test.id}.content`)}"
                          </p>
                          <div className="author">
                            ...
                            <div className="info">
                              ...
                              <p className="role">
                                {t(`testimonials.${test.id}.role`)}
                              </p>
                              <p className="hospital">
                                {t(`testimonials.${test.id}.hospital`)}
                              </p>
                            </div>
                          </div>
                        </div>
            ...
            <div className="slider-controls">
              ...
              <div className="play-pause-toggle">
                ...
                >
                  ...
                  <span>
                    {isAutoScrolling ? t("controls.pause") : t("controls.play")}
                  </span>
                </button>
